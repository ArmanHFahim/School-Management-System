...
<body>
    ...
    <div class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <li class="nav-links-li {{ request()->is('admin/admin*') || request()->is('admin/teacher*') || request()->is('admin/accountant*') || request()->is('admin/librarian*') || request()->is('admin/parent*') || request()->is('admin/student') || request()->is('admin/permission*') ? 'showMenu':'' }}">
          <div class="iocn-link">
              <a href="#">
                  ...
                  <span class="link_name">{{ get_phrase('Admission Corner English') }}</span>
              </a>
              <span class="arrow">
                <svg
          ...
          <ul class="sub-menu">
              <li>
                <a class="{{ (request()->is('admin/admin*')) ? 'active' : '' }}" href="{{ route('english-admission.index') }}">
                  ...
                  <span>
                    {{ get_phrase('Admission From English') }}
                  </span>
                </a>
              </li>
        ...
        <li class="nav-links-li {{ request()->is('admin/book*') || request()->is('admin/book_issue*') || request()->is('admin/noticeboard*') || request()->is('admin/events/list*') ? 'showMenu':'' }}">
            <div class="iocn-link">
                <a href="#">
                    <div class="sidebar_icon">
