	    ...
	    <div class="row flex-wrap">
	            ...
	            <div class="col-md-6">
	              <div class="dashboard_ShortListItem">
	                <div
	                  class="dsHeader d-flex justify-content-between align-items-center"
	                >
	                  <h5 class="title"><?php echo e(get_phrase('Staff')); ?></h5>
	                </div>
	                <div
	                  class="dsBody d-flex justify-content-between align-items-center"
	                >
	                  <div class="ds_item_details">
	                  	<?php $admin = DB::table('users')->where('role_id', 2)->where('school_id', auth()->user()->school_id)->get()->count() ?>
	                  	<?php $teacher = DB::table('users')->where('role_id', 3)->where('school_id', auth()->user()->school_id)->get()->count() ?>
						<?php $accountant = DB::table('users')->where('role_id', 4)->where('school_id', auth()->user()->school_id)->get()->count() ?>
						<?php $librarian = DB::table('users')->where('role_id', 5)->where('school_id', auth()->user()->school_id)->get()->count() ?>
	                    <h4 class="total_no"><?php echo e($admin + $teacher + $accountant + $librarian); ?></h4>
	                    <p class="total_info"><?php echo e(get_phrase('Total Staff')); ?></p>
	                  </div>
	                  <div class="ds_item_icon">
	                    <img
	                      src="<?php echo e(asset('public/assets/images/Staff_icon.png')); ?>"
	                      alt=""
	                    />
	                  </div>
	                </div>
	      ...
	      <div class="col-lg-6">
	        <div class="dashboard_report dashboard_attendance">
	          <div class="ds_report_header d-flex justify-content-between align-items-start">
	            ...
	            <a href="<?php echo e(route('admin.daily_attendance')); ?>" class="all_report_btn"><?php echo e(get_phrase('Go to Attendance')); ?></a>
	          </div>
	      ...
	      <div class="col-lg-7 col-md-6">
	        <div class="dashboard_report dashboard_income_report">
	          ...
	          >
	            <div class="ds_report_left">
	              <h4 class="title"><?php echo e(get_phrase('Income Report')); ?></h4>
	              <div
	                class="ds_report_count d-flex align-items-center"
	              >
	            ...
	            <div class="verticalMenu">
	              ...
	              >
	                <li><a class="dropdown-item" href="#"><?php echo e(get_phrase('Year')); ?></a></li>
	                <li><a class="dropdown-item" href="#"><?php echo e(get_phrase('Month')); ?></a></li>
	                <li><a class="dropdown-item" href="#"><?php echo e(get_phrase('Week')); ?></a></li>
	              </ul>
	            </div>
	          </div>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\Ekattor8\Ekattor8\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>