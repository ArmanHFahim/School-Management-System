...
<head>
	...
	<link rel="shortcut icon" href="<?php echo e(asset('public/assets/uploads/logo/favicon.png')); ?>">
	<title><?php echo e(phrase('Installation').' | '.phrase('Ekattor')); ?></title>
	
	<!-- Bootstrap CSS -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/vendors/bootstrap-5.1.3/css/bootstrap.min.css')); ?>">

    <!--Custom css-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/css/swiper-bundle.min.css')); ?>">
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/vendors/bootstrap-icons-1.8.1/bootstrap-icons.css')); ?>">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/css/datatables.min.css')); ?>">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/calender/main.css')); ?>">

    <!--Toaster css-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/css/toastr.min.css')); ?>">
...
<div class="page-container horizontal-menu">
	...
	<header class="navbar navbar-fixed-top ins-one">
		<div class="navbar-inner">
			...
			<div class="navbar-brand">
				<a href="#">
					<img width="130px" src="<?php echo e(asset('public/assets')); ?>/uploads/logo/light-logo.png" alt="">
				</a>
    ...
    <script src="<?php echo e(asset('public/assets/calender/main.js')); ?>"></script>
	<script src="<?php echo e(asset('public/assets/calender/locales-all.js')); ?>"></script>
...
<?php /**PATH D:\laragon\laragon\www\Ekattor8\Ekattor8\resources\views/install/index.blade.php ENDPATH**/ ?>