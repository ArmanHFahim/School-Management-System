    ...
    <nav class="pagination epagination-2">
        <ul class="pagination epagination-2">
            ...
            <?php if(!$paginator->onFirstPage()): ?>
                <li class="page-item">
                    <a class="page-link" href="<?php echo e(\Request::url()); ?>" rel="prev" aria-label="<?php echo app('translator')->get('pagination.first'); ?>">
            ...
            <?php if($paginator->hasMorePages()): ?>
                ...
                <li class="page-item">
                    <a class="page-link" href="<?php echo e(\Request::url().'?page='.$paginator->lastPage()); ?>" rel="last" aria-label="<?php echo app('translator')->get('pagination.last'); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 15 15" fill="none">
...
<?php endif; ?>
<?php /**PATH D:\laragon\laragon\www\Ekattor8\Ekattor8\resources\views/vendor/pagination/bootstrap-4.blade.php ENDPATH**/ ?>