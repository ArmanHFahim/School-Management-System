			...
			<div class="row flex-wrap">
							...
							<div class="col-md-12">
								<div class="dashboard_ShortListItem">
									<div
										...
										>
										<h5 class="title"><?php echo e(get_phrase('Schools')); ?></h5>
										<a href="<?php echo e(route('superadmin.school.list')); ?>" class="ds_link ds_sutdent">
											<svg
									...
									<div class="dsBody d-flex justify-content-between align-items-center" >
										<div class="ds_item_details">
											<h4 class="total_no"><?php echo e(DB::table('schools')->get()->count()); ?></h4>
											<p class="total_info"><?php echo e(get_phrase('Total Schools')); ?></p>
										</div>
								...
								<div class="dashboard_ShortListItem mt-3">
									<div
										class="dsHeader d-flex justify-content-between align-items-center"
										>
										<h5 class="title"><?php echo e(get_phrase('Subscription')); ?></h5>
										<a href="<?php echo e(route('superadmin.subscription.report')); ?>" class="ds_link ds_parent">
											<svg
												xmlns="http://www.w3.org/2000/svg"
												width="10.146"
												height="4.764"
									...
									<div class="dsBody d-flex justify-content-between align-items-center" >
										<div class="ds_item_details">
											<h4 class="total_no"><?php echo e(DB::table('subscriptions')->where('expire_date', '>=', time())->get()->count()); ?></h4>
											<p class="total_info"><?php echo e(get_phrase('Total Active Subscription')); ?></p>
										</div>
										<div class="ds_item_icon">
											<img
				...
				<div class="col-md-7">
                    <div class="card bg-info">
                        <h6 class="ms-4 mt-4 mb-5 text-white"><?php echo e(get_phrase('Subscription Payment')); ?></h6>
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\Ekattor8\Ekattor8\resources\views/superadmin/dashboard.blade.php ENDPATH**/ ?>