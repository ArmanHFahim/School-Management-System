    ...
    <div class="row justify-content-md-center">
        ...
        <div class="row mt-4">
            ...
            <div class="col-xl-4 p-1">
                <div class="col-12">
                    <a href="<?php echo e(asset('public/assets/csv_file/student.generate.csv')); ?>" class="btn btn-success btn-sm" download>Generate csv file <i class="bi bi-download"></i> </a>
...
<?php /**PATH D:\laragon\laragon\www\Ekattor8\Ekattor8\resources\views/admin/offline_admission/excel_student_admission.blade.php ENDPATH**/ ?>