<div class="offcanvas offcanvas-end eOffcanvas" data-bs-scroll="true" tabindex="-1" id="offcanvasScrollingRightBS" aria-labelledby="offcanvasScrollingRightLabel">
  <div class="offcanvas-header">
    <div class="eDisplay-5" id="offcanvasRightLabel"><?php echo e(get_phrase('Loading...')); ?></div>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content py-4">
      <div class="modal-header border-bottom-0">
        <h5 class="modal-title w-100 text-center"><?php echo e(get_phrase('Heads up!')); ?></h5>
      </div>
      <div class="modal-body text-center"><?php echo e(get_phrase('Are you sure?')); ?></div>
      <div class="modal-footer d-block border-top-0 text-center">
        <button type="button" class="btn btn-secondary modal-btn-close" data-bs-dismiss="modal" aria-label="Close"><?php echo e(get_phrase('Back')); ?></button>
        <a href="javascript:;" id="continue_btn" class="btn btn-danger"><?php echo e(get_phrase('Continue')); ?></a>
      </div>
    </div>
  </div>
</div>
  ...
  <div
    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <p><?php echo e(get_phrase('Are you sure?')); ?></p>
        <p class="focus-text"><?php echo e(get_phrase('You won\'t able to revert this!')); ?></p>
        <div class="confirmBtn">
          <a href="javascript:;" id="confirmBtn" class="eBtn eBtn-green">
            <button type="button" id="confirmBtn" class="eBtn eBtn-green"><?php echo e(get_phrase('Yes')); ?></button>
          </a>
          <button type="button" class="eBtn eBtn-red"
            data-bs-dismiss="modal"><?php echo e(get_phrase('Cancel')); ?></button>
        </div>
      </div>
    </div>
  </div>
...
<?php /**PATH D:\laragon\laragon\www\Ekattor8\Ekattor8\resources\views/modal.blade.php ENDPATH**/ ?>