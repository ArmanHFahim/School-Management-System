      ...
      <ul class="nav-links">
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/admin*') || request()->is('admin/teacher*') || request()->is('admin/accountant*') || request()->is('admin/librarian*') || request()->is('admin/parent*') || request()->is('admin/student') || request()->is('admin/permission*') ? 'showMenu':''); ?>">
          <div class="iocn-link">
              <a href="#">
                  ...
                  <span class="link_name"><?php echo e(get_phrase('Admission Corner English')); ?></span>
              </a>
              <span class="arrow">
                <svg
          ...
          <ul class="sub-menu">
              <li>
                <a class="<?php echo e((request()->is('admin/admin*')) ? 'active' : ''); ?>" href="<?php echo e(route('english-admission.index')); ?>">
                  ...
                  <span>
                    <?php echo e(get_phrase('Admission From English')); ?>
        ...
        <li class="nav-links-li <?php echo e(request()->is('hr/leave_list*') || request()->is('payroll/create/payslip*') || request()->is('attendence/list*') || request()->is('payroll/list*') || request()->is('hr/user/roles*') || request()->is('hr/user/list*')  ? 'showMenu':''); ?>">
            ...
            <ul class="sub-menu">
                ...
                <li>
                    <a class="<?php echo e((request()->is('hr/user/list*')) ? 'active' : ''); ?>" href="<?php echo e(route('hr.userlist_index')); ?>">
                        <span>
                            <?php echo e(get_phrase('User List')); ?>
                ...
                <li>
                    <a class="<?php echo e((request()->is('attendence/list*')) ? 'active' : ''); ?>" href="<?php echo e(route('hr.list_of_attendence')); ?>">
                        <span>
                            <?php echo e(get_phrase('Take Attendence')); ?>
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/book*') || request()->is('admin/book_issue*') || request()->is('admin/noticeboard*') || request()->is('admin/events/list*') ? 'showMenu':''); ?>">
            <div class="iocn-link">
                <a href="#">
                    <div class="sidebar_icon">
...
<?php /**PATH D:\laragon\laragon\www\Ekattor8\Ekattor8\resources\views/admin/navigation.blade.php ENDPATH**/ ?>